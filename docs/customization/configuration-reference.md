...
|`playlist` <sup>< 8.8.0</sup>|String|Tooltip text for, overlay heading for, and `aria-label` HTML attribute of a playlist overlay<br/><br/><font color="red">**WARNING**</font>: Starting with JW Player 8.8.0, use the [relate.heading](#intlrelatedheading) property to set this property.|Playlist|

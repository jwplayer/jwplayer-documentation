...
|**advertising.conditionaladoptout**|Boolean|(VPAID-only) This is used to tell the player to not play ads with the `conditionalAd` attribute inside of the VAST response.|VAST|false|

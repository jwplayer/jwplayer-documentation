...
|**.jw-icon-fullscreen**|.jw-svg-icon-fullscreen-on<br/><br/>.jw-svg-icon-fullscreen-offs|Container for entering and exiting fullscreen icons. This icon will toggle between fullscreen on and off depending on the state of the player.|
